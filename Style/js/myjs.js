...
function newchat(head) {
  ...
  lis.innerHTML = '<div class="d-flex bd-highlight"><div class="img_cont"><img src="./images/1s.png" class="rounded-circle user_img"><span class="online_icon"></span></div><div class="user_info"><span id="user_head'+newlenght+'">'+head+'</span><p>online</p></div></div>';
